Rails.application.configure do
  ...
  if ENV['APP_HOST_URL']
    host_uri = URI.parse(ENV['APP_HOST_URL'])
    config.action_controller.asset_host = host_uri.to_s
  ...
  #config.action_controller.asset_host = 'somewhere.example'
  ...
  config.active_record.migration_error = :page_load unless ENV['SKIP_MIGRATIONS'].present?
